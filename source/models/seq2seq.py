...
class Seq2Seq(BaseModel):
    ...
    def __init__(self, config):
        ...
        self.src_vocab_size = config.src_field.vocab_size
        self.tgt_vocab_size = config.tgt_field.vocab_size
        self.embed_size = config.embed_size
        self.hidden_size = config.hidden_size
        self.padding_idx = config.src_field.pad_token_id
        self.num_layers = config.num_layers
        self.bidirectional = config.bidirectional
        self.attn_mode = config.attn
        self.attn_hidden_size = None
